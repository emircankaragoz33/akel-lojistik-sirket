...
export const translations: Translations = {
    ...
    feat_perf_desc: { TR: 'Uzun süreli yanma ve dengeli ısı dağılımı ile üstün performans sağlar.', EN: 'Provides superior performance with long burning time and balanced heat distribution.' },
    ...
    feat_easy_desc: { TR: 'Hızlı tutuşma özelliği ile pratik kullanım sunar.', EN: 'Offers practical use with its fast ignition feature.' },
    ...
    story_p1: { TR: "2008 yılında Türkiye'de ilk mangal kömürü ithalatını gerçekleştirerek sektörde öncü bir rol üstlendik. Bu tarihten önceki lojistik ve farklı sektörlerdeki ithalat-ihracat tecrübemiz, bugünkü başarımızın ve güçlü operasyonel yapımızın temelini oluşturmaktadır.", EN: "We took a pioneering role in the sector by carrying out the first charcoal import in Turkey in 2008. Our experience in logistics and import-export in different sectors prior to this date forms the basis of our current success and strong operational structure." },
